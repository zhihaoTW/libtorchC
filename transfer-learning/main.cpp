...
int main(int argc, const char * argv[]) {
    ...
    std::string cats_name = "/home/zhihao/examples/cpp/transfer-learning/train/cat_test";
    std::string dogs_name = "/home/zhihao/examples/cpp/transfer-learning/train/dog_test";
